...
class Customer(AbstractBaseUser, PermissionsMixin):
    ...
    def email_email(self, suject, message):
        send_mail(
            suject,
            message,
            '1@1.com',
...
class Address(models.Model):
    ...
    delivery_instructions = models.CharField(_("Delivery Instructions"), max_length=250, blank=True)
    ...
    def __str__(self):
        return "{} Address".formet(self.full_name)